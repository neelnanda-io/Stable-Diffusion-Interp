...
class Pretrained:
    ...
    text_encoder = clip_text_encoder(pretrained_text_encoder)  # type: ignore
...
def stable_diffusion_inference(
    ...
    with t.autocast("cuda"):
        for i, ts in enumerate(scheduler.timesteps):
            ...
            latents = scheduler.step(noise_pred, i, latents)["prev_sample"]  # type: ignore - this is guaranteed by diffusers
